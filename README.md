...
<details>
  ...
  <div markdown="1">
    <ul>
      <li>코로나 이후 ott 서비스 변화 분석 :<a href="https://github.com/world970511/elice_OTT/blob/master/eda/OTT_covid_EDA.ipynb">코로나 이후 OTT서비스 변화 분석</a></li>
...
<details>
  ...
  <div markdown="1">
    <ul>
      ...
      또한, 추가적으로 ott서비스에 대한 분석을 통계자료로 제공해 각 ott서비스의 장단점을 파악할 수 있도록 돕는다.
      나아가 소비자의 ott 서비스 사용 빈도, 시청시간 데이터를 바탕으로 사용자의 ott서비스 이용도를 확인할 수 있도록 돕는다. </li>
    </ul>
  </div>
</details>
<details>
...
| OTT 관련 통계 제공 | 각 OTT 서비스의 콘텐츠 특징을 통계자료를 제공|
| OTT 사용 등급 검사 | 본인의 OTT서비스 사용 시간과 빈도를 바탕으로 OTT 사용 등급을 분류|
